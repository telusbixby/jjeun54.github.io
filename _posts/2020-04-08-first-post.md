...
사자다리는 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.
...
-보유근거 : finaldestination을 사용하기 위한 필수 정보, 롤하자를 사용하기 위한 필수 정보, maskinfo를 사용하기 위한 필수 정보
...
① ('https://sajadari.github.io/'이하 사자다리') 은(는) 다음의 개인정보 항목을 처리하고 있습니다.
